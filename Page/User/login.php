<?php 
    ...
    if ( isset($_POST['login']) ) {
        ...
        if ( Login('users',$data) == true ) {   //Jika login() berhasil
            $_SESSION['Login'] = true;
            $_SESSION['Stat'] = 'User';

            $result = Cari('users','Email',$Email);
            ...
            if ( isset($_POST['Remember']) ) {      //Jika 'Remember Me' dicentang
                ...
                $cookieStatus = hash('sha512','User');  // Cookie Pengecoh
                ...
                setcookie('Mode', 'User', time()+1800);
                
                // Simpan ke DB                
                query("INSERT INTO sessionss VALUES ('','User','$Username','$Email','$combination','Cookie','$date',$number)");
                ...
                $_SESSION['Attribute'] = hash('sha512','User'); // Session Pengecoh
                ...
                // Simpan ke DB
                query("INSERT INTO sessionss VALUES ('','User','$Username','$Email','$combination','Session','$date',$number)");
            }            
            header('Location: index.php');
            exit;
        } else {
            ...
            <form action="" method="POST">
                <table>
                    <tr>
                        ...
                        <td> <input type="text" name="Email" id="Email" autocomplete="off" placeholder="Ex. luffy@mugiwara.com"> </td>
                    </tr>
                    <tr>
