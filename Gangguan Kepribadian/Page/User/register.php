<?php 
    ...
    if ( isset($_POST['register']) ) {
        ...
        $daftarEmailChecker = mysqli_query($conn,"SELECT Email FROM users");
        $daftarEmail = assoc_query("SELECT Email FROM users");
        ...
        if ( Register('users',$userData,$userPicture) > 0 ) {
            echo    "<script>
            ...
            <form action="" method="POST" enctype="multipart/form-data">        
                <table>
                    <tr>
                        ...
                        <td> <input type="text" name="Username" id="Username" autocomplete="off" placeholder="Ex. Monkey D. Luffy"> </td>
                    </tr>
                    <tr>
